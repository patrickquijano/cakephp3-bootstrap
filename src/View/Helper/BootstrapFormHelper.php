...
class BootstrapFormHelper extends FormHelper {
    ...
    private $_templateSet = [
        ...
        'default' => [
            ...
            'nestingLabel' => '<div class="form-check{{checkInline}}">{{hidden}}{{input}}<label class="form-check-label"{{attrs}}>{{text}}</label></div>',
        ...
        'inline' => [
            ...
            'nestingLabel' => '<div class="form-check">{{hidden}}{{input}}<label class="form-check-label"{{attrs}}>{{text}}</label></div>',
            'radioContainer' => '<div class="form-group">{{content}}</div>',
            'radioContainerError' => '<div class="form-group">{{content}}</div>',
            'radioFormGroup' => '{{input}}{{error}}',
            'submitContainer' => '{{content}}',
