...
class BootstrapPaginatorHelper extends PaginatorHelper {
    ...
    private $_templateSet = [
        'default' => [
            ...
            'first' => '<li class="page-item d-none d-sm-block"><a class="page-link" aria-label="First" href="{{url}}">{{text}}</a></li>',
            'last' => '<li class="page-item d-none d-sm-block"><a class="page-link" aria-label="Last" href="{{url}}">{{text}}</a></li>',
            'number' => '<li class="page-item d-none d-sm-block"><a class="page-link" href="{{url}}">{{text}}</a></li>',
            'current' => '<li class="page-item active d-none d-sm-block"><span class="page-link">{{text}}</span> <span class="sr-only">(current)</span></li>',
